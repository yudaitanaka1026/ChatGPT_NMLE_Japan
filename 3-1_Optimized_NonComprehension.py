...
def modified_ask(name, translation, exam):
    ...
    for i in range(len(df)):
        ...
        english = openai.ChatCompletion.create(
            model="gpt-3.5-turbo",
            messages=[
                {"role": "system", "content": translation},
...
qtype = [
    "BasicsOfMedicine(essential)",
    "ClinicalMedicine(essential)",
    "BasicsOfMedicine(general)",
    "BasicsOfMedicine(specifics)",
    "ClinicalMedicine(general)",
    "ClinicalMedicine(specifics)",
]
